...
const organizationData = [
  { name: 'Greenwood High', users: 145, logs: 423, status: 'active' },
  { name: 'Northside College', users: 298, logs: 756, status: 'active' },
  { name: 'Eastwood Academy', users: 187, logs: 234, status: 'inactive' },
  { name: 'Central University', users: 445, logs: 1123, status: 'active' },
  { name: 'Tech Institute', users: 172, logs: 920, status: 'active' }
];
...
const MasterAdminDashboard: React.FC = () => {
  ...
  const logDistributionOptions: ApexOptions = {
    ...
    labels: ['Submitted', 'Under Review', 'Rejected', 'Approved'],
    legend: {
      position: 'bottom',
      labels: {
        colors: isDark ? '#9CA3AF' : '#6B7280'
  ...
  const logDistributionSeries = [1456, 892, 234, 874];
